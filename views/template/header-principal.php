...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/png" href="<?php echo RUTA_PRINCIPAL . 'assets'; ?>/hmedi/medi1.png">
				...
				<nav class="navbar navbar-expand-md navbar-light">
					<div class="container">
						<a class="navbar-brand" href="<?php echo RUTA_PRINCIPAL; ?>">
							<img src="<?php echo RUTA_PRINCIPAL . 'assets'; ?>/img/logo.png" width="210" alt="Logo">
						</a>
						<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
							<ul class="navbar-nav m-auto">
								<li class="nav-item">
									<a href="<?php echo RUTA_PRINCIPAL . 'lugar'; ?>" class="nav-link active">
										Lugares
								...
								<li class="nav-item">
									<a href="<?php echo RUTA_PRINCIPAL . 'login'; ?>" class="nav-link dropdown-toggle">
										iniciar sesión
									</a>
								<li class="nav-item">
									<a href="<?php echo RUTA_PRINCIPAL . 'registro'; ?>" class="nav-link dropdown-toggle">
									Registrarse	
									</a>
							</ul>
							</li>

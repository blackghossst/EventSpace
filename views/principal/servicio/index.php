        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="explore-img">
                    <img src="<?php echo RUTA_PRINCIPAL . 'assets' ;?>/img/explore-img.png" alt="Image">
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="col-lg-4">
                    <ul class="tabs">
                        <li class="single-rooms">
                            <img src="<?php echo RUTA_PRINCIPAL . 'assets' ;?>/img/rooms/button-img-1.jpg" alt="Image">
                        ...
                        <li class="single-rooms">
                            <img src="<?php echo RUTA_PRINCIPAL . 'assets' ;?>/img/rooms/button-img-2.jpg" alt="Image">
                            <div class="room-content">
                                <h3>Luxury Room</h3>
                        ...
                        <li class="single-rooms">
                            <img src="<?php echo RUTA_PRINCIPAL . 'assets' ;?>/img/rooms/button-img-3.jpg" alt="Image">
                            <div class="room-content">
                                <h3>Best Room</h3>
                        ...
                        <li class="single-rooms">
                            <img src="<?php echo RUTA_PRINCIPAL . 'assets' ;?>/img/rooms/button-img-4.jpg" alt="Image">
                            <div class="room-content">
                                <h3>Classic Room</h3>
                        ...
                        <li class="single-rooms">
                            <img src="<?php echo RUTA_PRINCIPAL . 'assets' ;?>/img/rooms/button-img-5.jpg" alt="Image">
                            <div class="room-content">
                                <h3>Budget Room</h3>
                                <span>From $95.9/night</span>
                            </div>
        ...
        <div class="testimonials-wrap owl-carousel owl-theme">
            <div class="single-testimonials">
                ...
                <div class="testimonials-content">
                    <img src="<?php echo RUTA_PRINCIPAL . 'assets' ;?>/img/testimonials/2.jpg" alt="Image">
                    <h4>Ayman Jenis</h4>
            ...
            <div class="single-testimonials">
                ...
                <p>“Awesome yksum dolor sit ametco elit, sed do eiusmod tempor incididunt et md do eiusmoeiusmod tempor inte emamnsecacing eiusmoeiusmod”</p>
                <div class="testimonials-content">
                    <img src="<?php echo RUTA_PRINCIPAL . 'assets' ;?>/img/testimonials/3.jpg" alt="Image">
                    <h4>Ayman Jenis</h4>
                    <span>CEO@Leasuely</span>
                </div>
            </div>
            <div class="single-testimonials">
                ...
                <p>“Awesome yksum dolor sit ametco elit, sed do eiusmod tempor incididunt et md do eiusmoeiusmod tempor inte emamnsecacing eiusmoeiusmod”</p>
                <div class="testimonials-content">
                    <img src="<?php echo RUTA_PRINCIPAL . 'assets' ;?>/img/testimonials/1.jpg" alt="Image">
                    <h4>Ayman Jenis</h4>
                    <span>CEO@Leasuely</span>
                </div>
            </div>
